...
<div id="main_container">
      ...
      <ul>
        ...
        <li><a href="#">Manage Tenant
          ...
          <ul>
            ...
            <li><a href="tenantlist.php">Tenant List</a></li>
  ...
  <div id="main_content">
    <div id="admin_header">
      <div class="admin_index_title">Lessor List</div>
    ...
    <div>
	  <?php
	      ...
	      include "dbconnect.php";
		  $rs=mysqli_query($Con, "select LID, Name, PhoneNo, email, password from lessor");
		  
		  echo "<table>";
		  echo "<tr><td>Lessor ID</td><td>Lessor Name </td><td>Phone No </td><td> Email</td><td> Password</td></tr>";
