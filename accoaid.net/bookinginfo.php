    ...
    <div class="table_grid">
      <table cellspacing="0" cellpadding="0">
        <tr>
          ...
          <th style="width:auto;"><a href="#" class="pink">Visiting Date</a></th>
          <th style="width:auto;"><a href="#" class="pink">Visiting Time</a></th>
		...
		<?php
		   $sql="select BookingRegister.BookingID,BookingRegister.BookingDate, BookingRegister.BookingTime, BookingRegister.VisitingDate, BookingRegister.VisitingTime,Tenant.Name, Tenant.PhoneNo from BookingRegister inner join Tenant on BookingRegister.TID=Tenant.TID where BookingRegister.PID='".$_GET['PID']."'";
		   ...
		   while($data=mysqli_fetch_row($rs))
		   {
			...
			echo "<td>".$data[5]."</td>";
			echo "<td>".$data[6]."</td>";
		    echo "<td><a href='#'><img alt='' src='images/adminicons/delete.png' width='24' height='24' border='0' /></a></td>";
            echo "</tr>";
		   }
        ?>
