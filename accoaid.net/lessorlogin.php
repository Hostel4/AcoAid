    ...
    <div class="admin_login">
      <div class="left_box">
        ...
        <div class="center_left_box">
          <div class="box_title"><span>Lessor</span> login</div>
          <div class="form">
            
			<div class="form_row">
			  <label>Returning Lessor </label>
            </div>
            <form action=lessorverification.php method=POST>
			<div class="form_row">
            ...
            <div style="float:right; padding:10px 25px 0 0;">
              <label style="font-size:2em">New Lessor?</label> <a href=newlessor.php><img src="images/join.gif"></img></a>
            </div>
