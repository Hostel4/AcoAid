...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!-- end of column three -->
    <div class="column4">
      <div class="title">Lessor Registration Error - Duplicate Email ID</div>
      <div class="contact_tab">
	  <form action=addtenant.php method=POST name=form1 onsubmit="return verify()">
        <div class="form_contact">
          <div class="form_row_contact" style="font-size:1.5em;">
              This Email id is already registered in our system
			  <form>
                <input type="button" value="Change Email ID" onclick="history.back()">
              </form>
          </div>
