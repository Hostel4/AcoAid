...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!-- end of column three -->
    <div class="column4">
      <div class="title">New Property Listed</div>
      <div class="contact_tab">
	  <form action=addtenant.php method=POST name=form1 onsubmit="return verify()">
        <div class="form_contact">
          <div class="form_row_contact" style="font-size:2em;">
              You have Succesfully Added New Property, <a href=lessorsection.php> Go to Lessor Section</a>
